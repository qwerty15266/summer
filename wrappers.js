...
<a class="container-oplata" id="qiwi-inp-other2"><img alt="" src="https://i.imgur.com/kb8M7vg.png" class="icon-user-oplata"><div class="textContainer-oplata"><span class="name-user">Пополнить картой</span><span class="category-user">Visa, Mastercard и Мир</span></div> <div class="textContainer-oplata"><span class="name-user">Оплата через администратора:</span><span class="category-user">Кирилл чмырь</span></div> <div class="textContainer-oplata"><span class="name-user">Оплата через администратора:</span><span class="category-user">Кирилл чмырь</span></div> <div class="textContainer-oplata"><span class="name-user">Оплата через администратора:</span><span class="category-user">Кирилл чмырь</span></div> </a>\
</div>\
